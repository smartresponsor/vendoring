...
final class VendorTransactionOperatorPageBuilderService implements VendorTransactionOperatorPageBuilderServiceInterface
{
    /**
...
HTML,
                ...
                $this->escape(VendorTransactionStatusValueObject::label($transaction->getStatus())),
                $vendorIdEscaped,
                $transaction->getId(),
                $transaction->getId(),
                $transaction->getId(),
...
HTML,
    ...
    private function renderStatusOptions(string $currentStatus): string
    {
        ...
        foreach (VendorTransactionStatusValueObject::labels() as $status => $label) {
