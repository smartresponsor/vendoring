...
namespace App\Vendoring\Service\Http\Vendor\Runtime\Status;
...
{
    public function __construct(private VendorRuntimeStatusProjectionBuilderServiceInterface $runtimeStatusProjectionBuilder)
    {
    }
