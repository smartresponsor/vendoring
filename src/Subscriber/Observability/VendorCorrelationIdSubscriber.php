...
namespace App\Vendoring\Subscriber\Observability;
 ...
 */
final class VendorCorrelationIdSubscriber implements EventSubscriberInterface
{
    private const string HEADER_NAME = 'X-Correlation-ID';
    private const string ATTRIBUTE_NAME = '_vendoring_correlation_id';

    public function __construct(private readonly VendorCorrelationContextServiceInterface $correlationContext) {}
