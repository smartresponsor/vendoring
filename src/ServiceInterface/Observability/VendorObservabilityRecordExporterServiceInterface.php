 ...
 * observability backends, but they must preserve the supplied stream nameEntity and payload.
 */
interface VendorObservabilityRecordExporterServiceInterface
{
    /**
     * Export one structured observability record to the named backend stream.
     *
     * @param string              $stream  stable stream nameEntity such as `runtime_logs` or `runtime_metrics`
