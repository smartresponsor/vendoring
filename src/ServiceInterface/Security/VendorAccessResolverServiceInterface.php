 ...
 */
interface VendorAccessResolverServiceInterface
{
    /**
     ...
     * @param string $capability Canonical capability nameEntity such as `ownership.read`.
     */
     ...
     * @param string $capability canonical capability nameEntity being checked
     *
