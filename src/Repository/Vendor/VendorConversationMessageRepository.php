...
use App\Vendoring\RepositoryInterface\Vendor\VendorConversationMessageRepositoryInterface;
...
final class VendorConversationMessageRepository extends ServiceEntityRepository implements VendorConversationMessageRepositoryInterface
{
    ...
    {
        parent::__construct($registry, VendorConversationMessageEntity::class);
    }
