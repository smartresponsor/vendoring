...
final class VendorConversationMessage
{
    #[ORM\Id]
    #[ORM\GeneratedValue]
    ...
    #[ORM\ManyToOne(targetEntity: VendorConversation::class)]
    ...
    public function __construct(VendorConversation $conversation, string $direction, string $body, ?Vendor $senderVendor = null, ?string $externalMessageId = null, array $meta = [])
    {
