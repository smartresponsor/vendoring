...
final class VendorWishlistItem
{
    #[ORM\Id]
    #[ORM\GeneratedValue]
    ...
    public function __construct(VendorWishlist $wishlist, string $targetType, string $targetId, int $quantity = 1, ?string $note = null)
    {
