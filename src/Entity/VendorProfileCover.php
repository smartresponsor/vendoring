...
#[ORM\UniqueConstraint(name: 'uniq_vendor_profile_cover_vendor', columns: ['vendor_id'])]
/**
 * @noinspection PhpPropertyNamingConventionInspection
 */
final class VendorProfileCover
{
    #[ORM\Id]
    #[ORM\GeneratedValue]
    ...
    public function __construct(Vendor $vendor, string $filePath)
    {
        $this->vendor = $vendor;
