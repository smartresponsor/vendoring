...
- Write-only neighboring services should expose runtime summaries through local projections instead of leaking remote provider contracts into surface builders.
