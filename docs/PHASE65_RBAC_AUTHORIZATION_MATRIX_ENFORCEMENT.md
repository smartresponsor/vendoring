...
`App\ValueObject\VendorRole` defines the allowed vendor-local roles:
- `owner`
- `operator`
- `finance`
- `viewer`
...
`App\ServiceInterface\Security\VendorAuthorizationMatrixInterface`
`App\Service\Security\VendorAuthorizationMatrix`
...
`App\ServiceInterface\Security\VendorAccessResolverInterface`
`App\Service\Security\VendorAccessResolver`
