...
final class VendorSecurityServiceTest extends TestCase
{
    ...
    {
        $existingKey = new VendorApiKey(new Vendor('Acme Vendor'), 'hash', 'read:transactions');
        $service = new VendorSecurityService($this->apiKeyService);
    ...
    {
        $key = new VendorApiKey(new Vendor('Acme Vendor'), 'hash', 'read:transactions');
        $service = new VendorSecurityService($this->apiKeyService);
