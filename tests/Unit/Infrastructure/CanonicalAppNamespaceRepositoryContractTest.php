...
final class CanonicalAppNamespaceRepositoryContractTest extends TestCase
{
    public function testRepositoryOperationalServiceConfigUsesCanonicalAppNamespace(): void
    {
        ...
        self::assertStringContainsString('App\\ServiceInterface\\Order\\OrderPaymentInterface:', $content);
        self::assertStringContainsString('alias: App\\Service\\Order\\OrderPaymentService', $content);
