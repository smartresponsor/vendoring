...
use App\Vendoring\Service\Crud\VendorCrudService;
...
final class VendorCrudServiceTest extends TestCase
{
    ...
    private function buildService(): VendorCrudService
    {
        return new VendorCrudService(
