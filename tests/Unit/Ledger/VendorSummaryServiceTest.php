...
final class VendorSummaryServiceTest extends TestCase
{
    public function testBuildIncludesPayoutFeeInBalances(): void
    {
        ...
        $repository->insert(new VendorLedgerEntryEntity('3', 'tenant-1', 'payout_fee', 'CASH', 15.0, 'USD', 'fee', 'fee-1', 'vendor-1', '2026-03-15 10:00:00'));
        $repository->insert(new VendorLedgerEntryEntity('4', 'tenant-1', 'REVENUE', 'CASH', 999.0, 'EUR', 'invoice', 'inv-2', 'vendor-1', '2026-03-16 10:00:00'));
    ...
    {
        $repository = new InMemoryLedgerEntryRepository();
        $repository->insert(new VendorLedgerEntryEntity('1', 'tenant-1', 'REVENUE', 'CASH', 40.0, 'USD', 'invoice', 'inv-early', 'vendor-1', '2026-03-01 00:00:00'));
        $repository->insert(new VendorLedgerEntryEntity('2', 'tenant-1', 'REVENUE', 'CASH', 60.0, 'USD', 'invoice', 'inv-late', 'vendor-1', '2026-03-31 23:59:59'));
    ...
    {
        $repository = new InMemoryLedgerEntryRepository();
        $repository->insert(new VendorLedgerEntryEntity('1', 'tenant-1', 'REVENUE', 'CASH', 40.0, 'USD', 'invoice', 'inv-usd', 'vendor-1', '2026-03-10 10:00:00'));
        $repository->insert(new VendorLedgerEntryEntity('2', 'tenant-1', 'REVENUE', 'CASH', 60.0, 'EUR', 'invoice', 'inv-eur', 'vendor-1', '2026-03-11 10:00:00'));
