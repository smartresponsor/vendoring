...
final class VendorServiceEntityCompatibilityTest extends TestCase
{
    /**
    ...
    private function assertEntityDefinesProperties(string $className, array $properties): void
    {
        ...
        foreach ($properties as $property) {
            self::assertTrue(
                ...
                sprintf('%s must define $%s for current vendor service reflection flow.', $className, $property),
            );
        }
    }
