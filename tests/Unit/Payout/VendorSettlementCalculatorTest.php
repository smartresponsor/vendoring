...
use App\Service\Payout\VendorSettlementCalculator;
use App\Tests\Support\Repository\InMemoryLedgerEntryRepository;
use PHPUnit\Framework\TestCase;

final class VendorSettlementCalculatorTest extends TestCase
{
    public function testNetForPeriodReturnsPositiveVendorPayableBalance(): void
    {
        ...
        $calculator = new VendorSettlementCalculator($repository);
