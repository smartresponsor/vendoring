...
final class VendorSettlementCalculatorServiceTest extends TestCase
{
    public function testNetForPeriodReturnsPositiveVendorPayableBalance(): void
    {
        ...
        $repository->insert(new VendorLedgerEntryEntity('1', 'tenant-1', 'VENDOR_PAYABLE', 'REVENUE', 150.00, 'USD', 'invoice', 'inv-1', 'vendor-1', '2026-03-10 10:00:00'));
        $repository->insert(new VendorLedgerEntryEntity('2', 'tenant-1', 'CASH', 'VENDOR_PAYABLE', 40.00, 'USD', 'payout', 'po-1', 'vendor-1', '2026-03-11 10:00:00'));
        $repository->insert(new VendorLedgerEntryEntity('3', 'tenant-1', 'VENDOR_PAYABLE', 'REVENUE', 999.00, 'EUR', 'invoice', 'inv-2', 'vendor-1', '2026-03-12 10:00:00'));
        $repository->insert(new VendorLedgerEntryEntity('4', 'tenant-2', 'VENDOR_PAYABLE', 'REVENUE', 777.00, 'USD', 'invoice', 'inv-3', 'vendor-1', '2026-03-12 10:00:00'));
    ...
    {
        $repository = new InMemoryLedgerEntryRepository();
        $repository->insert(new VendorLedgerEntryEntity('1', 'tenant-1', 'CASH', 'VENDOR_PAYABLE', 75.00, 'USD', 'payout', 'po-1', 'vendor-1', '2026-03-10 10:00:00'));
