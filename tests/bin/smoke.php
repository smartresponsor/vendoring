...
fwrite(STDOUT, '[OK] statement, payout, http-service-coverage, and repository scripts are registered in master smoke'.PHP_EOL);
...
// Zero-controller hardening smoke is intentionally callable as a standalone script:
