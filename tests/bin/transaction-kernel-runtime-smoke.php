...
$listResponse = KernelRuntimeHarness::requestJson($kernel, 'GET', '/api/vendor/transaction/vendor-smoke');
...
$updateResponse = KernelRuntimeHarness::requestJson($kernel, 'POST', '/api/vendor/transaction/status/'.(string) $createId, [
    'status' => 'authorized',
], $authHeaders);
